...
This is the shortest path from a clean checkout to the current 52-space
...
- the Snapshot contains exactly 52 named CW spaces in 18 families;
...
not the source of the 52-space Snapshot. The exporter builds and validates the
